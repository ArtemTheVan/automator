...
- Эмуляция ввода с клавиатуры (включая UTF-8 / кириллицу) через WinAPI `SendInput`.
- Эмуляция действий мыши: клики, перемещения, перетаскивание, последовательности событий.
